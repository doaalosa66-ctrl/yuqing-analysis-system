...
class Settings(BaseSettings):
    ...
    DB_DIALECT: Optional[str] = Field("mysql", description="数据库方言")
    ...
    DEFAULT_TIME_PERIOD: str = Field("month", description="默认时间范围")
    DEFAULT_SEARCH_TOPIC_GLOBALLY_LIMIT_PER_TABLE: int = Field(50, description="全局话题最大数")
    ...
    OUTPUT_DIR: str = Field(str(PROJECT_ROOT / "outputs" / "raw_md"), description="输出路径")
