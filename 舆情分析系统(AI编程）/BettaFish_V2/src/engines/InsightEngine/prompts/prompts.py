...
output_schema_first_search = {
    ...
    "properties": {
        ...
        "time_period": {"type": "string", "description": "时间周期，search_hot_content工具可选，可选值：24h, week, month, year"},
...
[CRITICAL REQUIREMENT] 你必须严格只输出原始Markdown报告内容。禁止输出任何对话式开场白、前言、确认语或元评论，例如"好的"、"收到"、"以下是报告"等。必须直接以主标题（# 深度研究报告 或 # 【舆情洞察】）开头。
